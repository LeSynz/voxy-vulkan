package xyz.synz.voxyvulkan.common.config;
...
public class Serialization {
    ...
    public static void init() {
        String BASE_SEARCH_PACKAGE = "xyz.synz.voxyvulkan";
        ...
        for (var clzName : clazzs) {
            if (VoxyCommon.IS_DEDICATED_SERVER&&clzName.startsWith("xyz.synz.voxyvulkan.client")) {
